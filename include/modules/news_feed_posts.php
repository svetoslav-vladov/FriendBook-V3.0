<div id="newsfeed">
    ...
    $pdo = new PostDao();
    $allPosts = $pdo->getAllPosts();
    foreach ($allPosts as $post) {?>
        <div class="post">
            <div class="user_info">
                <div class="icon"><a href="profile.php?id=<?php echo $post['user_id']?>"><img src="<?php echo $post['profile_pic']; ?>" alt="icon" title="<?php echo $post["first_name"] . " " . $post["last_name"]; ?>" class="img-rounded center-block"></a></div>
