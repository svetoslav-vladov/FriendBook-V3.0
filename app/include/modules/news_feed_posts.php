<div id="newsfeed">
    ...
    foreach ($allPosts as $post) {?>
        <div class="card p-3 mt-3 mb-3">
            <div class="user_info">
                <div class="icon"><a href="<?php echo URL_ROOT; ?>/index/profile?id=<?php echo $post['user_id']?>"><img src="<?php echo URL_ROOT . $post['profile_pic']; ?>" alt="icon" title="<?php echo $post["first_name"] . " " . $post["last_name"]; ?>" class="img-rounded center-block"></a></div>
